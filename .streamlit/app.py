...
with tab4:
     ...
     styled_df = df_display.style.set_properties(**{"background-color":"#1C2541","color":"white","text-align":"center"}).set_table_styles([{"selector":"th","#3A506B"),("color","white"),("text-align","center")]}])
