...
with tab1:
     ...
     with col1:
          ...
          gauge={'axis': {'range': [0, 100], 'tickwidth': 1,'tickcolor':"white"},'bar': {'color':"#2563eb", 'thickness': 0.3},'bgcolor':"#111827",
          'borderwidth':2,'bordercolor':"#374151",'steps': [{'range': [0, 40], 'color': "#16a34a"},
          {'range': [40, 70],'color':"#ca8a04"},{'range': [70, 100], 'color':"#dc2626"}],
          'threshold': {'line': {'color':"#ffffff", 'width':4},'thickness':0.8,'value':new_risk}}))

          fig1.update_layout(height=400,margin=dict(l=20, r=20, t=50, b=20), font={'color':"white"})
