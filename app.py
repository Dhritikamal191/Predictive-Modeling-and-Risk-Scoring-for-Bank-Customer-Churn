...
with tab2:
     ...
     fig2 = px.bar(importance_df,x="Importance",y="Feature",orientation="h", title="Feature Importance", color="Importance", color_continuous_scale=[[0.0, "#22c55e"], [0.1/max_val, "#eab308"], [0.2/max_val, "#f97316"], [0.3/max_val, "#8b5cf6"]])
