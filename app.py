...
with tab1:
     ...
     with col1:
          ...
          gauge={'axis': {'range': [0, 100], 'tickwidth': 1,'tickcolor':"white"},'bar': {'color':"#06b6d4", 'thickness': 0.3},'bgcolor':"#111827",
          'borderwidth':2,'bordercolor':"#374151",'steps': [{'range': [0, 40], 'color': "#4ade80"},
          {'range': [40, 70],'color':"#facc15"},{'range': [70, 100], 'color':"#ef4444"}],
